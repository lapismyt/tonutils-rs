...
mod tests {
    ...
    use std::sync::Arc;
    use tonutils_metadata::{Tep64KnownKey, Tep64Value, tep64_key_hash};
    use tonutils_tlb::{Anycast, MsgAddress, MsgAddressExt, MsgAddressInt, TlbSerialize};
    use tonutils_tvm::{Address, BitKey, Builder, Cell, HashmapE, Slice, TvmStack, TvmStackEntry};
    ...
    mod provider_tests {
        ...
        fn call(
            ...
            ExpectedCall {
                account,
                method_id: crate::method_name_to_id(method),
                stack,
                result,
                exit_code,
            }
        ...
        async fn collection_helper_uses_latest_block_empty_stack_and_method_id() {
            ...
            assert_eq!(
                ...
                vec![crate::method_name_to_id("get_collection_data")]
            );
        }
        ...
        async fn item_helper_uses_latest_block_empty_stack_and_method_id() {
            ...
            assert_eq!(
                provider.seen_methods,
                vec![crate::method_name_to_id("get_nft_data")]
            );
        }
        ...
        async fn full_item_helper_passes_index_and_individual_content() {
            ...
            assert_eq!(
                provider.seen_methods,
                vec![crate::method_name_to_id("get_nft_content")]
            );
        }
