...
impl WalletV5R1ExtendedActionList {
    ...
    pub fn new(actions: Vec<WalletV5R1ExtendedAction>) -> tonutils_tlb::Result<Self> {
        if actions.is_empty() {
    ...
    fn load_actions(
        slice: &mut Slice,
        depth: usize,
    ) -> tonutils_tlb::Result<Vec<WalletV5R1ExtendedAction>> {
...
impl WalletV4R2 {
    ...
    pub async fn send_external_message<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
        seqno: u32,
        valid_until: u32,
...
impl WalletV5R1 {
    ...
    #[cfg(feature = "provider")]
    pub async fn seqno<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
    ...
    #[cfg(feature = "provider")]
    pub async fn wallet_id_onchain<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
    ) -> Result<u32, WalletGetMethodError<P::Error>> {
    ...
    #[cfg(feature = "provider")]
    pub async fn public_key_onchain<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
    ...
    #[cfg(feature = "provider")]
    pub async fn is_signature_allowed_onchain<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
    ...
    #[cfg(feature = "provider")]
    pub async fn extensions_raw_onchain<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
    ...
    /// `get_extensions`.
    #[cfg(feature = "provider")]
    pub async fn extensions_onchain<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
    ...
    #[cfg(feature = "provider")]
    async fn run_v5r1_get_method<P: tonutils_contracts::ContractProvider + ?Sized>(
        &self,
        provider: &mut P,
        method: &'static str,
    ) -> Result<tonutils_tvm::TvmStack, WalletGetMethodError<P::Error>> {
        use tonutils_contracts::{DecodedRunMethodResult, RunMethodResultExt};
        use tonutils_tvm::TvmStack;
        ...
        let result = provider
            .run_get_method(
                ...
                block,
                self.address()?,
                crate::method_name_to_id(method),
                TvmStack::empty(),
            )
            .await
            .map_err(WalletGetMethodError::Provider)?;
