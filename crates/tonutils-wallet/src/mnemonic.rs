...
use std::thread;
use tonutils_tlb::{TlbDeserialize, TlbError, TlbSerialize};
use tonutils_tvm::{Address, BitKey, Builder, Cell, HashmapE, Slice};

pub(super) const TON_MNEMONIC_WORD_COUNT: usize = 24;
pub(super) const TON_DEFAULT_SEED: &[u8] = b"TON default seed";
pub(super) const TON_SEED_VERSION: &[u8] = b"TON seed version";
pub(super) const TON_FAST_SEED_VERSION: &[u8] = b"TON fast seed version";
pub(super) const TON_DEFAULT_SEED_ITERATIONS: usize = 100_000;
pub(super) const TON_SEED_VERSION_ITERATIONS: usize = 100_000 / 256;
pub(super) const TON_FAST_SEED_VERSION_ITERATIONS: usize = 1;

pub(super) const WALLET_V4R2_PLUGINS_KEY_BITS: usize = 256;
pub(super) const WALLET_V4R2_MAX_MESSAGES: usize = 4;
pub(super) const WALLET_V4R2_SIMPLE_SEND_OP: u32 = 0;
/// Default Wallet V4R2 wallet id used by common TON wallets.
pub const WALLET_V4R2_DEFAULT_ID: u32 = 0x29a9_a317;
pub(super) const WALLET_V4R2_CODE_BOC_HEX: &str = "";

pub(super) const WALLET_V5R1_EXTERNAL_SIGNED_OP: u32 = 0x7369_676e;
pub(super) const WALLET_V5R1_EXTENSIONS_KEY_BITS: usize = 256;
pub(super) const WALLET_V5R1_MAX_ACTIONS: usize = 255;
pub(super) const WALLET_V5R1_ADD_EXTENSION_TAG: u8 = 0x02;
pub(super) const WALLET_V5R1_DELETE_EXTENSION_TAG: u8 = 0x03;
pub(super) const WALLET_V5R1_SET_SIGNATURE_AUTH_ALLOWED_TAG: u8 = 0x04;
pub(super) const WALLET_V5R1_CLIENT_CONTEXT_FLAG: u32 = 1 << 31;
pub(super) const WALLET_V5R1_CLIENT_SUBWALLET_BITS: u32 = 15;
pub(super) const WALLET_V5R1_CLIENT_SUBWALLET_MAX: u16 =
    (1 << WALLET_V5R1_CLIENT_SUBWALLET_BITS) - 1;
pub(super) const WALLET_V5R1_CODE_BOC_HEX: &str = "";
...
pub(super) fn ton_mnemonic_seed_from_phrase(
    phrase: &str,
    seed: &[u8],
    password: Option<&str>,
    iterations: usize,
...
pub(super) fn validate_ton_mnemonic_phrase(
    phrase: &str,
    password: Option<&str>,
) -> Result<(), WalletError> {
...
pub(super) fn validate_ton_mnemonic_words(
    words: &[String],
    password: Option<&str>,
) -> Result<(), WalletError> {
...
pub(super) fn validate_ton_seed_version_byte(
    byte: u8,
    password: Option<&str>,
) -> Result<(), WalletError> {
...
impl TlbSerialize for WalletV5R1Extensions {
    fn store_tlb(&self, builder: &mut Builder) -> tonutils_tlb::Result<()> {
...
impl TlbDeserialize for WalletV5R1Extensions {
    fn load_tlb(slice: &mut Slice) -> tonutils_tlb::Result<Self> {
        let inner =
...
pub(super) fn extension_hash_key(hash: [u8; 32]) -> BitKey {
...
pub(super) fn cached_wallet_code(
...
pub(super) fn decode_wallet_v4r2_code() -> Result<Arc<Cell>, WalletError> {
    let mut bytes = hex::decode(WALLET_V4R2_CODE_BOC_HEX)
        .map_err(|error| WalletError::CodeDecode(error.to_string()))?;
    strip_boc_crc32c_for_local_decoder(&mut bytes);
    tonutils_tvm::deserialize_boc(&bytes).map_err(WalletError::Tvm)
}

pub(super) fn decode_wallet_v5r1_code() -> Result<Arc<Cell>, WalletError> {
...
pub(super) fn strip_boc_crc32c_for_local_decoder(bytes: &mut Vec<u8>) {
    if bytes.len() >= 9
