...
impl LiteBalancer {
    ...
    pub async fn raw_get_block(&mut self, id: BlockIdExt) -> Result<tonutils_tlb::Block> {
        balanced_call!(self, tonutils_tlb::Block, false, |client| client
    ...
    pub async fn run_get_method(
        ...
        let params = stack.to_boc().map_err(|e| {
            BalancerError::LiteError(LiteError::TlError(tonutils_tl::TlError::ParseError(
                e.to_string(),
            )))
        })?;
    ...
    pub async fn run_get_method_by_name(
        ...
        self.run_get_method(mode, id, account, crate::method_name_to_id(method), stack)
            .await
    }
    ...
    pub async fn raw_get_transactions(
        ...
        balanced_call!(
            self,
            (Vec<tonutils_tlb::Transaction>, Vec<BlockIdExt>),
            false,
    ...
    pub async fn get_one_transaction_typed(
        ...
        balanced_call!(self, Option<tonutils_tlb::Transaction>, false, |client| {
    ...
    pub async fn raw_get_block_transactions_ext(
        ...
        balanced_call!(self, Vec<tonutils_tlb::Transaction>, false, |client| {
    ...
    ) -> Result<HashMap<Int256, Option<Arc<tonutils_tvm::Cell>>>> {
        balanced_call!(
            self,
            HashMap<Int256, Option<Arc<tonutils_tvm::Cell>>>,
            false,
