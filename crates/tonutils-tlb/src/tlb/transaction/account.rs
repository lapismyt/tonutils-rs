...
use tonutils_tvm::{Builder, HashmapAug, HashmapAugE, HashmapE, Slice};

pub(super) const OUT_MSG_KEY_BITS: usize = 15;
pub(super) const VAR_UINT_3_LEN_BITS: usize = 2;
pub(super) const VAR_UINT_3_MAX_BYTES: usize = 2;
