...
- `tonutils-overlay` provides bounded overlay peer, routing, and status primitives.
...
The current release exposes bounded peer/event primitives and offline-safe
ingest. Live DHT discovery, UDP overlay schemas, and production peer bootstrap
remain tracked protocol work. The behavioral reference for this design is
